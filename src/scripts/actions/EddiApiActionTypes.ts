...
export const DEPLOY_INITIAL_BOTS: string = 'DEPLOY_INITIAL_BOTS';
export const DEPLOY_INITIAL_BOTS_SUCCESS: string =
  'DEPLOY_INITIAL_BOTS_SUCCESS';
export const DEPLOY_INITIAL_BOTS_FAILED: string = 'DEPLOY_INITIAL_BOTS_FAILED';
