  ...
  services: [
    ...
    },
    {
      ...
      scripts: [
        {
          id: 'external-script',
          src: 'https://cdn.jsdelivr.net/gh/labsai/EDDI-Manager-Dist@1.0.1/vendor/gtag.js',
        },
      ],
      cookies: [{ pattern: 'cookie-name' }],
      mandatory: false,
      description:
        'Google Tag Manager is a tag management system (TMS) that allows us to quickly and easily update measurement codes and related code fragments collectively known as tags on your website or mobile app. Google Tag Manager gives us the ability to add and update your own tags for conversion tracking, site analytics, remarketing, and more. For more information on how Google LLC uses this data, go to https://policies.google.com/privacy',
    },
  ],
  theme: 'dark',
};
